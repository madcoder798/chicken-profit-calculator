...
<body>
    ...
    <div class="benefits">
        <div class="benefit-box">
            <img src="https://cdn.pixabay.com/photo/2022/11/07/15/47/chicken-wings-7576679_1280.jpg" alt="Chicken Dish 1">
            <h4>High Protein Source</h4>
            <p>Chicken is rich in protein, essential for muscle growth and repair.</p>
        </div>
        <div class="benefit-box">
            <img src="https://cdn.pixabay.com/photo/2018/07/29/23/37/barbecue-3571403_1280.jpg" alt="Chicken Dish 2">
            <h4>Boosts Immunity</h4>
            <p>Contains vitamins B6 & B12, which help strengthen the immune system.</p>
        </div>
        <div class="benefit-box">
            <img src="https://cdn.pixabay.com/photo/2016/07/31/17/51/chicken-1559548_1280.jpg" alt="Chicken Dish 3">
            <h4>Heart Health</h4>
            <p>Low in saturated fat, helps maintain healthy cholesterol levels.</p>
        </div>
        <div class="benefit-box">
            <img src="https://cdn.pixabay.com/photo/2022/05/19/20/21/fried-legs-7208116_1280.jpg" alt="Chicken Dish 4">
